...
con theme a la medida (paleta desde la marca, radius por registro, par
tipográfico propio)". La audiencia elige la estética,
...
- Nunca el mismo par tipográfico que el sitio anterior del mismo giro (la
  anti-convergencia llavea en acento+hero+navbar; tú extiende la
  diferenciación al par de fuentes cuando haya empate).
